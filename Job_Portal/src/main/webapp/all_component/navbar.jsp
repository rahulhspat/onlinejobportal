	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<c:if test="${userobj.role eq 'admin' }">
				...
				<a href="#"class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" class="btn btn-light mr-1"><i class="fas fa-user"></i>Admin</a>
			...
			<c:if test="${userobj.role eq 'user' }">
				...
				<a href="#"class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" class="btn btn-light mr-1"><i class="fas fa-user"></i>${userobj.name}</a>
				<a href="logout" class="btn btn-light mr-1"><i
					class="fas fa-sign-in-alt"></i>Log Out</a>
			</c:if>
